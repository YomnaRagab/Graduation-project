...
const u8 PinsPerPort[PORTS_NUMBER]={PORTA_PIN_NUM,PORTB_PIN_NUM,PORTC_PIN_NUM,PORTD_PIN_NUM,PORTE_PIN_NUM,PORTF_PIN_NUM}; //Array that holds the number of pins per port
